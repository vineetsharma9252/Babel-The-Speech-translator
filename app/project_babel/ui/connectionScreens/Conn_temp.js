...
export default function Conn() {
    const { connectionState, localMicOn, setLocalMicOn,
            qrCodeText, selectedLanguage, setSelectedLanguage
        } = useContext(Context);
    const text = useRef("");
    ...
    useEffect(() => {
        ...
        text.current = (!isUserConnected) ? "Scanning...": "Connected"
